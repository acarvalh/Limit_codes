...
{
  style();
  TString fileBaseName(TString::Format("hgg.hig.mH%.1f_8TeV.vbf", mass));
  ...
  //
  TString ssignal = "/afs/cern.ch/work/o/obondu/public/forRadion/limitTrees/v28/v28_fitToMgg_noKinFit/vbf_m125_8TeV_m260.root";
  //
...
void MakeSigWS(RooWorkspace* w, const char* fileBaseName) {
  ...
  wAll->factory("prod::CMS_hgg_sig_m0_vbf_cat0(mgg_sig_m0_cat0, CMS_hgg_sig_m0_absShift)");
  wAll->factory("prod::CMS_hgg_sig_m0_vbf_cat1(mgg_sig_m0_cat1, CMS_hgg_sig_m0_absShift)");
  // (3) Systematics on resolution
  wAll->factory("CMS_hgg_sig_sigmaScale[1,1,1]");
  wAll->factory("prod::CMS_hgg_sig_sigma_vbf_cat0(mgg_sig_sigma_cat0, CMS_hgg_sig_sigmaScale)");
  //wAll->factory("prod::CMS_hgg_sig_sigma_cat0(mgg_sig_sigma_cat0, CMS_hgg_sig_sigmaScale)");

  wAll->factory("prod::CMS_hgg_sig_sigma_vbf_cat1(mgg_sig_sigma_cat1, CMS_hgg_sig_sigmaScale)");
  wAll->factory("prod::CMS_hgg_sig_gsigma_vbf_cat0(mgg_sig_gsigma_cat0, CMS_hgg_sig_sigmaScale)");
  wAll->factory("prod::CMS_hgg_sig_gsigma_vbf_cat1(mgg_sig_gsigma_cat1, CMS_hgg_sig_sigmaScale)");
...
TString::Format("EDIT::CMS_hgg_sig_vbf_cat%d(mggSig_cat%d,",c,c) +
TString::Format(" mgg_sig_m0_cat%d=CMS_hgg_sig_m0_vbf_cat%d, ", c,c) +
TString::Format(" mgg_sig_sigma_cat%d=CMS_hgg_sig_sigma_vbf_cat%d, ", c,c) +
...
TString::Format(" mgg_sig_gsigma_cat%d=CMS_hgg_sig_gsigma_vbf_cat%d)", c,c)
  );
...
minSigFit+1.5,0.75*plotmgg[c]->GetMaximum(),catdesc.at(c));
    ...
    //latex -> Draw("same");
    ctmp->SaveAs(TString::Format("sigmodel_vbf_cat%d.pdf",c));
    ctmp->SaveAs(TString::Format("sigmodel_vbf_cat%d.png",c));
