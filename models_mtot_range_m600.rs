...
mtot_sig_m0_cat0[600, 550, 650];
mtot_sig_sigma_cat0[6.0, 3.0, 10.0];
mtot_sig_alpha_cat0[1.0, -4.0, 4.0];
mtot_sig_n_cat0[4.0, 0.1, 30.0];
mtot_sig_gsigma_cat0[15.0, 1.0, 40.0];
mtot_sig_frac_cat0[0.1, 0.05, 0.4];

mtot_sig_m0_cat1[630, 550, 650];
mtot_sig_sigma_cat1[20.0, 0.5, 30.0];
mtot_sig_alpha_cat1[-0.5, -1.0, 3.0];
mtot_sig_n_cat1[10.0, 5.0, 40.0];
