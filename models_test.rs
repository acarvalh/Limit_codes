...
mgg_hig_m0_1_cat0[110.0, 105, 155];
mgg_hig_sigma_1_cat0[1.2, 0.8, 1.6];
mgg_hig_alpha_1_cat0[2.0, 1.0, 2.5];
mgg_hig_n_1_cat0[2.0, 1.0, 5.0];
mgg_hig_gsigma_1_cat0[5.0, 3.0, 8.0];
mgg_hig_frac_1_cat0[0.1, 0, 0.2];

mgg_hig_m0_1_cat1[110.0, 70, 160];
mgg_hig_sigma_1_cat1[1.8, 1.3, 2.5];
mgg_hig_alpha_1_cat1[2.0, 1.2, 5];
mgg_hig_n_1_cat1[2.0, 1.5, 10];
mgg_hig_gsigma_1_cat1[5.0, 3.0, 8.0];
mgg_hig_frac_1_cat1[0.1, 0, 0.3];
