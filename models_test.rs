...
mgg_hig_sigma_0_cat0[4.0, 3.0, 6.0];
mgg_hig_alpha_0_cat0[1.0, -2.5, 2.5];
mgg_hig_n_0_cat0[2.0, 1.0, 5.0];
mgg_hig_gsigma_0_cat0[1.8, 1.3, 2.5];
mgg_hig_frac_0_cat0[0.5, 0.0, 1.0];

mgg_hig_m0_0_cat1[125.0, 124, 126];
mgg_hig_sigma_0_cat1[4.0, 3.0, 6.0];
mgg_hig_alpha_0_cat1[1.0, -2.5, 2.5];
mgg_hig_n_0_cat1[2.0, 1.5, 10];
mgg_hig_gsigma_0_cat1[1.8, 1.3, 2.5];
mgg_hig_frac_0_cat1[0.5, 0.0, 1.0];
...
mgg_hig_sigma_1_cat0[4.0, 3.0, 6.0];
mgg_hig_alpha_1_cat0[1.0, -2.5, 2.5];
mgg_hig_n_1_cat0[2.0, 1.0, 5.0];
mgg_hig_gsigma_1_cat0[1.8, 1.3, 2.5];
mgg_hig_frac_1_cat0[0.5, 0.0, 1.0];

mgg_hig_m0_1_cat1[124.0, 123, 126];
mgg_hig_sigma_1_cat1[4.0, 3.0, 6.0];
mgg_hig_alpha_1_cat1[1.0, -2.5, 2.5];
mgg_hig_n_1_cat1[2.0, 1.5, 10];
mgg_hig_gsigma_1_cat1[1.8, 1.3, 2.5];
mgg_hig_frac_1_cat1[0.5, 0.0, 1.0];
...
mgg_hig_sigma_2_cat0[4.0, 3.0, 6.0];
mgg_hig_alpha_2_cat0[1.0, -2.5, 2.5];
mgg_hig_n_2_cat0[2.0, 1.0, 5.0];
mgg_hig_gsigma_2_cat0[1.8, 1.3, 2.5];
mgg_hig_frac_2_cat0[0.5, 0.0, 1.0];

mgg_hig_m0_2_cat1[125.0, 124, 126];
mgg_hig_sigma_2_cat1[4.0, 3.0, 6.0];
mgg_hig_alpha_2_cat1[1.0, -2.5, 2.5];
mgg_hig_n_2_cat1[2.0, 1.5, 10];
mgg_hig_gsigma_2_cat1[1.8, 1.3, 2.5];
mgg_hig_frac_2_cat1[0.5, 0.0, 1.0];
...
mgg_hig_sigma_3_cat0[4.0, 3.0, 6.0];
mgg_hig_alpha_3_cat0[1.0, -2.5, 2.5];
mgg_hig_n_3_cat0[2.0, 1.0, 5.0];
mgg_hig_gsigma_3_cat0[1.8, 1.3, 2.5];
mgg_hig_frac_3_cat0[0.5, 0.0, 1.0];

mgg_hig_m0_3_cat1[125.0, 124, 126];
mgg_hig_sigma_3_cat1[4.0, 3.0, 6.0];
mgg_hig_alpha_3_cat1[1.0, -2.5, 2.5];
mgg_hig_n_3_cat1[2.0, 1.5, 10];
mgg_hig_gsigma_3_cat1[1.8, 1.3, 2.5];
mgg_hig_frac_3_cat1[0.5, 0.0, 1.0];
